 ...
 */
final class Version20250318175144 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE devis ADD user_id INT NOT NULL, DROP date');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE devis ADD date DATE NOT NULL, DROP user_id');
    }
}
